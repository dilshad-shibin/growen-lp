...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="Leedz Enquiry from Google Ads, " . $name;
    ...
    $apiKey = urlencode('2Q1Xhn7DcpA1J6sb');
    $utm_id = "4202414628";
    $agent = "59921576";
...
// More headers
$headers .= 'From: <msdcva786@gmail.com>' . "\r\n";

$to = "ajithleedzacademy@gmail.com, dilshadkp05@gmail.com";
$url = 'http://viralmafia.com/demo/jsonmailersolacenew.php';
$ch = curl_init($url);
$data = array(
    'to' => $to,
